...
public class ViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_view_espenses, container, false);

        EditText fromDateEditText = rootView.findViewById(R.id.fromId);
        EditText toDateEditText = rootView.findViewById(R.id.toId);


        fromDateEditText.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Bundle data = new Bundle();
                data.putString("dateType", "fromDate");
        ...
        toDateEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle data = new Bundle();
                data.putString("dateType", "toDate");
